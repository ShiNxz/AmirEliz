...
const Project = ({ title, description, image, techs, links, dataAosOffset, dataAos, dataAosDelay }) => {
    ...
    return (
        <div data-aos-delay={dataAosDelay || ""} data-aos={dataAos || ""} data-aos-offset={dataAosOffset || ""} data-aos-anchor="#projects" className="overflow-hidden relative shadow-md duration-200 hover:shadow-xl rounded-lg cursor-pointer m-auto mx-0 w-full h-full block text-left">
