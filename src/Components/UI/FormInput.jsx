const FormInput = ({ id, name, type, placeholder, className, dataAos, dataAosDelay, onChange }) => {
	return (
		<div data-aos-offset='650' data-aos={dataAos} data-aos-delay={dataAosDelay} data-aos-anchor='#contact' className="ltr:text-left rtl:text-right mb-8">
